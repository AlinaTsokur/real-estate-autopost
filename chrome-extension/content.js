...
#ul-body { padding: 12px; }
#ul-widget.collapsed #ul-body { display: none; }
#ul-search-row { display: flex; gap: 6px; margin-bottom: 10px; }
#ul-input {
  flex: 1;
  background: #1e293b;
  border: 1px solid #334155;
...
.ul-val { color: #f1f5f9; word-break: break-all; margin-top: 1px; }
.ul-val a { color: #818cf8; text-decoration: none; }
...
#ul-msg { font-size: 12px; color: #94a3b8; margin-top: 4px; }
`;
